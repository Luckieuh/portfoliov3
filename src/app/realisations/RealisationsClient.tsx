                            ...
                            <div>
                                <div className="w-full relative category-dropdown-container">
                                    <button 
                                        ...
                                        className="w-full whitespace-nowrap shrink-0 z-10 inline-flex justify-between items-center py-2.5 px-4 text-sm font-medium text-center text-black bg-white outline dark:outline-none rounded-full outline-neutral-400 hover:bg-neutral-200 bg-white" 
                                        type="button"
                                    >
                                ...
                                <Link key={project.id} href={`/realisations/${project.id}`} className="block group">
                                    <div className="overflow-hidden bg-zinc-200 border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 rounded-xl cursor-pointer transition-all duration-400">
                                        ...
                                        <div className="px-5 py-2">
                                            ...
                                            <div className="flex items-end justify-between gap-2 mt-5 min-h-[40px]">
