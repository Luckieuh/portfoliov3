...
export default function Propos() {
    return (
        <div className="w-full min-h-screen dark:bg-neutral-900 bg-neutral-100 overflow-x-hidden">
            <Header />
            <WireframePropos />
            <div className='w-full h-[3vh] md:h-[12vh]'></div>
            ...
            <div className='flex flex-col lg:flex-row justify-center space-x-52'>
                ...
                <div className='flex flex-col items-start mr-5 pb-5 w-[90%] lg:w-[40vw] relative mt-10 lg:mt-0 left-1/2 transform -translate-x-1/2 lg:left-0 lg:translate-x-0'>
                    <div className='scale-110 mb-5'>
                        <Outils />
                    </div>
                    <div className='box-shadow-glow-orange border-2 border-orange-400 w-full md:w-fit  p-2 space-y-5'>
                        ...
                        <div className='flex mb-2 flex-col space-y-2'>
                            ...
                            <div className='flex flex-col sm:items-end space-y-3'>
                                {/* Première ligne */}
                                <div className='flex flex-row flex-wrap space-y-3 sm:space-x-4'>
                                    <BtnShadow 
                                        bgColor="rgba(29, 47, 66, 0.63)"
                                        borderColor="#60CA91"
                                        img="/Davinci.webp"
                                        text="Davinci Resolve"
                                        textColor="white"
                                        classnamea='rounded-lg w-full sm:w-fit'
                                    />
