...
export default function BtnShadow({ bgColor, borderColor, img, text, textColor, link }: BtnShadowProps) {
    return (
        <a  href={link}
            ...
            className="group w-fit h-fit relative py-1 items-center justify-center overflow-hidden rounded-lg border-1 px-6 flex transition-all ease-[cubic-bezier(.47,1.64,.41,.8)] duration-400 hover:scale-108"
        >
