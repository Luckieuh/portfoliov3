      ...
      <div className="w-full max-w-2xl">
        <div className="bg-slate-800/50 backdrop-blur border border-slate-700 rounded-lg shadow-xl p-8">
          ...
          <div className="space-y-4 mb-6">
            <div>
              ...
              <input
                ...
                disabled={loading}
              />
              <p className="text-slate-400 text-xs mt-1">Défaut: mig_2024_production_secure_token_change_this</p>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-700">
            <p className="text-slate-400 text-xs mb-3">📝 Informations:</p>
            <ul className="text-slate-400 text-xs space-y-1 list-disc list-inside">
              <li>Cette page exécute les migrations Prisma sur la BD</li>
              <li>Elle crée les tables si elles n'existent pas</li>
              <li>Aucune donnée existante ne sera supprimée</li>
              <li>À utiliser une seule fois après le déploiement</li>
            </ul>
          </div>
